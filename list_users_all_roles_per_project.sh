...
prefix="roles/"
#gcloud projects get-iam-policy dev-datalake-217411 --format="table(bindings.role)"
...
#gcloud projects get-iam-policy dev-datalake-217411 --flatten="bindings[].members" --format="table(bindings.members)" --filter="bindings.role:${arr[1]}"
